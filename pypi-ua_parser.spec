...
Source0  : https://files.pythonhosted.org/packages/41/a6/141d256db13675ba1668f25b8566a7a6d6ceaae27e1df393c62443b88667/ua-parser-0.16.0.tar.gz
...
%prep
%setup -q -n ua-parser-0.16.0
cd %{_builddir}/ua-parser-0.16.0
pushd ..
cp -a ua-parser-0.16.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661194480
